  ...
  return (
    <div className="p-5 md:p-10 lg:px-20 w-full tracking-wider h-[60vh] md:h-[45vh] lg:h-[45vh] xl:h-[60vh] flex flex-col md:flex-row justify-around items-center gap-3 md:gap-[1%]">
      {promo_2.map((promo, index) => (
        <div
          key={index}
          className={`relative w-full md:w-[49.5%] h-[50%] md:h-[80%] flex justify-between pl-[46%] sm:pl-[45%] md:pl-[25%] lg:pl-[25%]`}
        >
          <img
            src={`/promotionTwo/${promo.src}`}
            alt="Promotions"
          ...
          <div className="content my-auto w-[70vw] md:w-[50vw] z-20 flex gap-1 lg:gap-3 flex-col justify-between md:px-2">
            <p className="text-sm lg:text-md tracking-widest font-semibold">
              {promo.p}
            </p>
            ...
            <button
              ...
              className="bg-[#c5172e] text-white py-2 md:py-3 md:px-6 mt-2 xl:mt-4 text-sm lg:text-md font-medium w-[60%] md:w-[90%] lg:w-[70%] hover:bg-white hover:text-black hover:cursor-pointer transition duration-200 ease-in-out"
            >
              SHOP NOW
            </button>
          </div>
