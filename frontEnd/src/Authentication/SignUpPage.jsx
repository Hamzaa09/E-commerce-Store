...
const Login = () => {
  ...
  const onSubmit = async (data) => {
    const response = await dispatch(signupUserThunk(data));
    ...
    <>
      ...
      <div className="flex flex-col justify-center items-center min-h-fit 2xl:w-[1500px] 2xl:mx-auto">
        ...
        >
            ...
            <div className="border border-GrayLight">
              <input
                ...
                {...register("password", {
                  ...
                  minLength: {
                    value: 8,
                    message: "Must be greater than 8 letters!",
                  },
                })}
                id="password"
                className="peer border-0 border-GrayLight outline-0 px-5 sm:px-5 pt-3 pb-2 sm:pt-4 sm:pb-3 text-md w-full"
          ...
          <div className="relative w-[90%]">
            <div className="border border-GrayLight">
              ...
              <label
                ...
                className={`absolute left-0 py-2 sm:py-3 translate-y-[-35%] scale-[0.7] px-0 peer-placeholder-shown:px-5 peer-placeholder-shown:scale-100 peer-placeholder-shown:translate-0 text-Gray text-md sm:text-lg transition-all duration-150 peer-focus:translate-y-[-35%] peer-focus:scale-[0.7] peer-focus:px-0 hover:cursor-text select-none`}
              >
                Confirm Password
              </label>
            </div>
          ...
          {/* checkbox  */}
          <div className="relative w-[90%]">
            <div className="flex justify-start px-3 gap-1">
              <input
                type="checkbox"
                id="t&c"
                {...register("terms", {
              ...
              />
              <label htmlFor="t&c" className="hover:cursor-pointer">
                Agreed to our{" "}
                <Link
            ...
            <span className="text-Red text-sm p-3">
          ...
          <button
            type="submit"
            className="bg-Red text-white py-2 text-lg font-medium w-[50%] border hover:bg-white hover:text-black hover:border-GrayLight  hover:cursor-pointer transition duration-200 ease-in-out mt-2 lg:mt-5 active:translate-y-1"
          >
            {screenLoading ? (
            ...
            <div className="mt-5 flex gap-4 flex-col bigSm:flex-row transition-all duration-300 ease-in-out">
              ...
              >
                <img
                  ...
                  className="h-[20px]"
                />
                <span className="text-sm md:text-base">Signup with Google</span>
              </button>
          ...
          <p className="pt-5 text-sm">
            ...
            <Link className="text-Red  underline" to={"/login"}>
              Login
            </Link>
          </p>
        </form>
