  ...
  return (
    <div className="flex flex-col md:flex-row w-full gap-6 animate-pulse">
      ...
      <div className="md:sticky md:top-0 md:w-1/2 flex flex-col items-center mt-10 ml-5">
        {/* Main Image */}
        <div className="w-[60%] md:w-[80%] h-[26rem] bg-gray-200 rounded-md"></div>

        {/* Thumbnails */}
        <div className="w-[80%] md:w-full mt-4 px-5 flex gap-3 justify-center">
          {[...Array(4)].map((_, i) => (
            <div
              key={i}
              className="h-[6em] w-[8em] bg-gray-200 rounded-md"
            ></div>
          ))}
        </div>
      </div>
