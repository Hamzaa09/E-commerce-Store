    ...
    >
      ...
      <div className="owl-carousel main-section owl-theme w-full flex justify-center items-center">
        {imgArr.map((obj, index) => (
          <div key={index} className="relative w-full h-[35vh] sm:h-[40vh] md:h-[50vh] lg:h-[70vh] bg-right opacity-[85%] bg-cover flex flex-col text-white tracking-wide">

          <img src={obj.src} className="absolute h-full w-full object-cover object-[40%]" alt="" />

            {/* content  */}
            <div className={`content ${obj.text_color} w-fit my-auto sm:mr-5 h-fit z-20 flex flex-col gap-2 sm:gap-3 md:gap-5 lg:gap-7 justify-between ml-[40%] sm:ml-[50%] md:ml-[50%] xl:ml-[55%]`}>
              ...
              <button className="bg-white text-black py-2 lg:py-4 text-sm xl:text-md font-medium w-[50%] hover:bg-[#c5172e] hover:text-white hover:cursor-pointer transition duration-200 ease-in-out mt-2 lg:mt-5">
                SHOP NOW
              </button>
            </div>
          </div>
